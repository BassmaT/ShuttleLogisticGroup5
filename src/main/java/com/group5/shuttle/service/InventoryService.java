...
public class InventoryService implements IInventoryService {
    ...
    private static final class Holder {
        static final InventoryService INSTANCE = new InventoryService();
    }
